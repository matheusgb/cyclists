...
func TestGetAllBikeEventsRepositorySuccessWithoutParam(t *testing.T) {
...
func TestGetAllBikeEventsRepositorySuccessWithParam(t *testing.T) {
	db, mock := tests.MockDatabase()
	domain := initGetAllBikeEventsPaginationMockedDomain()
...
func TestGetAllBikeEventsRepositoryError(t *testing.T) {
	db, mock := tests.MockDatabase()
	domain := initGetAllBikeEventsPaginationMockedDomain()
