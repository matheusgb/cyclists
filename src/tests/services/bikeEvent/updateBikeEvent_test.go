...
func TestUpdateBikeEventService(t *testing.T) {
	...
	t.Run("SuccessUser", func(t *testing.T) {
		...
		repository.EXPECT().UpdateBikeEvent(*domain, domain.Organizer).Return(entity, nil)

		entity, err := service.UpdateBikeEvent(*domain, "user", domain.Organizer)
	...
	t.Run("SuccessAdmin", func(t *testing.T) {
		...
		repository.EXPECT().UpdateBikeEventAdmin(*domain).Return(entity, nil)

		entity, err := service.UpdateBikeEvent(*domain, "admin", domain.Organizer)
